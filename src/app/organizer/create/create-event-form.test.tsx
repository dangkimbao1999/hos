...
const CATEGORIES: CategoryOption[] = [{ id: "cat-solo-singer", name: "Solo Singer", subcategories: [] }];
...
describe("CreateEventForm — toasts", () => {
  it("shows a success toast when the event is created", async () => {
    render(<CreateEventForm categories={CATEGORIES} />);
    ...
    fireEvent.change(screen.getByLabelText("Category"), { target: { value: "cat-solo-singer" } });
...
describe("CreateEventForm — event photos", () => {
